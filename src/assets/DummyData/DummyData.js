...
export const profile = [
    {
      ...
      summary: 'Result-driven Front End Developer passionate about developing user-friendly website design. Excellent problem-solving skills and ability to perform well in a team. Seeking to become the next Front End Developer, as well as grow and develop my own skills as a coder.'
    },
]

export const education = [
    {
       school: 'Glints Academy Batch 10 x Binar Academy',
...
export const skills = [
    'HTML5', 'CSS3', 'Javascript', 'ReactJS', 'GIT', 'Redux'
]
